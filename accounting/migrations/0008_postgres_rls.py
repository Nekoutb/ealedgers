...
Renumbered from 0006 → 0008 to follow 0007_bankstatement (introduced after
this branch was first cut). Dependencies updated accordingly.
"""

from django.db import migrations


# Tenant-scoped tables that exist on main as of step 2. Keep this list in
# sync with new models added to accounting/models.py. Order is irrelevant
# to RLS but kept stable for readability of the policy log.
TENANT_TABLES = [
    ...
    'accounting_supplierbill',
    'accounting_supplierbillline',
    'accounting_bankstatement',
    'accounting_bankstatementline',
]
